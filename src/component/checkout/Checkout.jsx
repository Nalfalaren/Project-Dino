...
const Checkout = () => {
  ...
  const [userData, setUserData] = useState({
    firstName: '', lastName: '', phoneNumber: '', address: '', cardHolder: '', cardNumber: '', expirationDate: '', cvv: ''
  });
    ...
    <div className='checkout-page'>
      ...
      <div className='checkout'>
        <div className='product-link'>
          ...
          <Link to={"/"} className='link'>Back to Hompage</Link>
        </div>
          ...
          <form action='/payment' method='POST' onSubmit={handleSubmit}>
            ...
            <div className='checkout-left'>
              ...
              <div className='checkout-name'>
                <div className='checkout-firstname'>
                  ...
                  <input type='text' name='firstName' value={userData.firstName} onChange={handleUserData}></input>
                </div>
                <div className='checkout-lastname'>
                  <label>Last Name</label>
                  <input type='text' name='lastName' value={userData.lastName} onChange={handleUserData}></input>
                </div>
              </div>
              <div className='checkout-phonenumber'>
                <label>Phone Number</label>
                <input type='text' name='phoneNumber' value={userData.phoneNumber} onChange={handleUserData}></input>
              </div>
              <div className='checkout-address'>
                <label>Street Address</label>
                <input type='text' name='address' value={userData.address} onChange={handleUserData}></input>
              </div>
            </div>
            <div className='checkout-right'>
              ...
              <div className='payment-cardholder'>
                ...
                <input type='text' name='cardHolder' value={userData.cardHolder} onChange={handleUserData}></input>
              </div>
              <div className='payment-number'>
                <label>Card number</label>
                <input type='text' name='cardNumber' value={userData.cardNumber} onChange={handleUserData}></input>
              </div>
              <div className='payment-subinfo'>
                <div className='payment-date'>
                  <label>Expiration Date</label>
                  <input type='text' name='expirationDate' value={userData.expirationDate} onChange={handleUserData}></input>
                </div>
                <div className='payment-cvv'>
                  <label>CVV</label>
                  <input type='text' name='cvv' value={userData.cvv} onChange={handleUserData}></input>
                </div>
              </div>
            </div>
            </div>
      ...
      <div className='order'>
       ...
       {isSent && <Success isSent={isSent} setIsSent={setIsSent} handleSent={handleSent} totalPrice={totalPrice}></Success>}
    </div>
  )
}
